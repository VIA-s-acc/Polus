...
/**
 * @file jacobi_mpi.c
 * @brief Solves a system of linear equations using the Jacobi iterative method with MPI parallelization.
...
/**
 * @brief Reads the local portion of a matrix and a vector from files.
 *
 * @param[out] matrix Pointer to the local portion of the matrix.
 * @param[out] vector Pointer to the local portion of the vector.
 * @param[in] size Total size of the matrix and vector.
 * @param[in] matrix_file Name of the file containing the matrix.
 * @param[in] vector_file Name of the file containing the vector.
 * @param[in] rank Rank of the current MPI process.
 * @param[in] num_procs Total number of MPI processes.
 */
...
/**
 * @brief Performs the Jacobi iterative method to solve a system of linear equations.
 *
 * @param[in] matrix Local portion of the matrix.
 * @param[in] vector Local portion of the vector.
 * @param[in,out] result Result vector updated with the solution.
 * @param[in] size Total size of the system.
 ...
 *
 * The program initializes MPI, reads the input matrix and vector, performs the Jacobi method
 * to solve the system of linear equations, and writes the results to files.
 *
 * Command-line arguments:
 * - `N=<size>`: Size of the matrix and vector.
 * - `eps=<tolerance>`: Convergence tolerance.
 * - `A=<matrix_file>`: Path to the matrix file.
 * - `b=<vector_file>`: Path to the vector file.
 *
